                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('session.save') }}">
                                ...
                                <select id="event_id" class="form-control" name="event_id">
                                    ...
                                    @if( $events )
                                        @foreach( $events as $event )
                                            <option value="{{ $event->id }}" {{ $event->id == $eventId ? "selected='selected'" : "" }}>{{ $event->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input id="event_date" type="text" class="form-control datetimepicker" name="start_time" value="">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input id="event_date" type="text" class="form-control datetimepicker" name="end_time" value="">
                            </div>
